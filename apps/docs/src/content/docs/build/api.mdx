---
title: REST API
description: oma exposes a REST API under /v1/* for managing agents, sessions, environments, skills, vaults, integrations, and more. SSE for live session events.
---
...
|---|---|
| Hosted (production) | `https://app.oma.duyet.net` |
| Hosted (staging) | `https://app.staging.oma.duyet.net` |
...
**Session cookie** — what the Console UI uses (better-auth-issued). Not normally what you'll integrate against unless you're embedding oma in a browser app.
...
<LinkCard
  title="CLI & SDK"
  href="/build/cli-sdk/"
  description="Skip curl: use the Node CLI or import @duyet/oma-api-types DTOs."
/>
<LinkCard
  title="Skills & Tools"
