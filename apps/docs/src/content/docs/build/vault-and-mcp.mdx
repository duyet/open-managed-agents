...
agent.mcp_tool_use:
  ...
  input: { team: "Oma", limit: 1, orderBy: "updatedAt" }
...
- Internal architecture deep-dive: [`docs/mcp-credential-architecture.md`](https://github.com/duyet/oma/blob/main/docs/mcp-credential-architecture.md)
- E2E test fixture: [`test/fixtures/fake-oauth-mcp/`](https://github.com/duyet/oma/tree/main/test/fixtures/fake-oauth-mcp) — a deployable CF Worker that plays both OAuth provider and MCP server, used to drill the refresh path without burning real-provider credentials.
