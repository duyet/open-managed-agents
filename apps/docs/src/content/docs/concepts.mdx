---
title: Concepts
description: A one-page tour of every noun in oma — Agent, Session, Environment, Vault, Memory Store, Skill, Tool, Harness, Integration.
---

import { Aside, LinkCard } from '@astrojs/starlight/components';

oma has nine core concepts. Skim this page once and most of the docs will make sense. Each section ends with a link to where the concept is used in depth.
...
The agent loop itself — the code that decides what the model does next given the session events. oma ships a **DefaultHarness** built on the [`ai` SDK](https://sdk.vercel.ai/), but the harness interface is pluggable. You can register a custom harness that:
