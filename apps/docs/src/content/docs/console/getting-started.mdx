...
The Console at [app.oma.duyet.net](https://app.oma.duyet.net) is the easiest way to use openma — no API calls, no curl. This page walks through what's where and how to get to "first agent running" without leaving the browser.
