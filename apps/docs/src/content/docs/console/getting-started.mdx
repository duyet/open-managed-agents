...
description: Sign up, create an agent, run a session, manage skills and vaults — all from the oma.duyet.net UI.
---

import { Steps, Aside, LinkCard } from '@astrojs/starlight/components';

The Console at [app.oma.duyet.net](https://app.oma.duyet.net) is the easiest way to use oma — no API calls, no curl. This page walks through what's where and how to get to "first agent running" without leaving the browser.

## Sign in

Email + OTP, or Google OAuth. On first sign-in, oma auto-creates a tenant for you. No invite codes or admin setup.
