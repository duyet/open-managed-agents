...
See the agent-side playbook at [`skills/oma/integrations-linear.md`](https://github.com/duyet/oma/blob/main/skills/oma/integrations-linear.md) for the full step-by-step.
