...
You can run all of openma — the API, the Console, the integrations gateway, and the agent runtime — yourself. The same code that powers [oma.duyet.net](https://app.oma.duyet.net) is the code in the public repo; nothing is held back.
