...
-- POST /v1/telemetry/ingest). Self-host Node counterpart of the
...
CREATE INDEX `idx_telemetry_installs_instance` ON `telemetry_installs` (`instance_id`);--> statement-breakpoint
CREATE INDEX `idx_telemetry_installs_created_at` ON `telemetry_installs` (`created_at`);--> statement-breakpoint
