...
CREATE INDEX "idx_telemetry_command" ON "telemetry_events" USING btree ("command");--> statement-breakpoint
CREATE INDEX "idx_telemetry_os" ON "telemetry_events" USING btree ("os");
